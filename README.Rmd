...
A single block performs a single __task__, such as loading or filtering or visualisation.
...
- __non technical__ users are empowered to create insightful data workflows using pre-built blocks that can be __easily__ connected, all without writing a single line of code.
- __developers__ are provided with a set of tools to seamlessly create new blocks, thereby enhancing the entire framework and fostering __collaboration__ within organizations teams.
