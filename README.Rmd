...
- On the one hand, it empowers __non technical__ users to create insightful data workflows using pre-built blocks that can be __easily__ connected, all without writing a single line of code.
- On the other hand, it provides __developers__ with a set of tools to seamlessly create new blocks, thereby enhancing the entire framework and fostering __collaboration__ within organizations teams.
...
A rich __API__ is provided to connect your own blocks and override the default behaviours (e.g., you can add your own GUI layer or serialisation).
...
If you wish to learn to develop your own blocks, have a look at this [vignette](https://cynkra.github.io/blockr.core/articles/2-create-block.html).

## What is a block?

A __block__ is a fundamental unit of a data analysis workflow.
A single block performs a single __tasks__, such as loading or filtering or visualisation.
...
To get started, we invite you to read this [vignette](https://cynkra.github.io/blockr.core/articles/1-get-started.html).
