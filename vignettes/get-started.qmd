...
2. Click on `Add block` and add a new `Select block`, givin it `transform` as custom id.
...
possible to initialise the board with few blocks, stacks and links:
...
If you wish to customise the look and feel of block, look no further than this [article](https://cynkra.github.io/blockr.core/articles/extend-blockr.html).